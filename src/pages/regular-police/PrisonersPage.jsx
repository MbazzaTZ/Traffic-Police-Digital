  ...
  return (
    <DashboardLayout pageTitle="Prisoners" pageTitle2="Wafungwa">
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:18 }}>
        <div>
          <h1 style={{ fontSize:22, fontWeight:700, color:"var(--navy-700,#0D3477)", fontFamily:"var(--font-serif,Georgia,serif)", margin:0 }}>Prisoners Register <span style={{ color:"#94A3B8", fontWeight:400, fontSize:16 }}>· Daftari ya Wafungwa</span></h1>
